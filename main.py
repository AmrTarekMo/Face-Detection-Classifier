...
#importPic("data/amr","updated/amr")
#importPic("data/qabil","updated/qabil")
#importPic("data/aloli","updated/aloli")
#importPic("data/ba5","updated/ba5")
#importPic("data/gar","updated/gar")
#importPic("data/zizo","updated/zizo")


labelData("updated/amr",0)
labelData("updated/aloli",1)
labelData("updated/ba5",2)
labelData("updated/qabil",3)
labelData("updated/zizo",4)
labelData("updated/gar",5)
